...
def args_parser():
    ...
    parser_fedgkf.add_argument('--lr_kd', type=float, default=0.001, help='1e-3 wich cos in paper')
    parser_fedgkf.add_argument('--T_kd', type=float, default=20.0)
    parser_fedgkf.add_argument('--optim_kd', type=str, default='adam')
    parser_fedgkf.add_argument('--sched_kd', type=str, default='cos')

    parser_fedgkf.add_argument('--feats_loc', type=int, default=-1)
    parser_fedgkf.add_argument('--r_ceil', type=float, default=0.75)
    parser_fedgkf.add_argument('--theta_tune', type=float, default=0.5)
    parser_fedgkf.add_argument('--mode_r', type=str, default='constant', help='constant, decay, inc')
    parser_fedgkf.add_argument('--mode_theta', type=str, default='decay', help='constant, decay, inc')
    parser_fedgkf.add_argument('--deci_mu', type=int, default=6)
